...
describe('Contact', () => {
  ...
  test('button Send should send the mail', async () => {
    ...
    expect(await screen.findByPlaceholderText('Enter a subject')).toBeInTheDocument();
    expect(await screen.findByPlaceholderText('Enter your message')).toBeInTheDocument();
  });
});
